    ...
    <div className={`min-h-screen font-sans transition-colors duration-300
      ...
      <section
        ...
        className={`relative flex flex-col items-center justify-center py-24 px-4 sm:px-6 lg:px-8 overflow-hidden
                    ${theme === 'dark' ? 'bg-dark-bg-primary text-dark-text-primary' : 'bg-light-bg-primary text-light-text-primary'} 
      ...
      >
        <div className="relative z-10 p-4 max-w-3xl mx-auto w-full text-center">
          ...
          <p className={`text-lg sm:text-xl mb-8 opacity-95
                          ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-blue-accent'}`}> {/* Changed text-blue-100 to text-blue-primary */}
          ...
          <div className="relative w-full max-w-xl mx-auto">
            <input
              ...
              className={`w-full py-3.5 pl-5 pr-14 border border-blue-accent rounded-full shadow-xl focus:outline-none focus:ring-4
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        >
          <h2 className={`text-3xl sm:text-4xl font-extrabold mb-8 text-center
                          ${theme === 'dark' ? 'text-dark-text-primary' : 'text-blue-accent'}`}>
            Lowongan Terbaru
          </h2>
          {loading ? (
